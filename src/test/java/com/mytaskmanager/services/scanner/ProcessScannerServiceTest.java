...
class ProcessScannerServiceTest {
    ...
    private static List<ProcessModel> scannedProcesses;
    ...
    void scanProcesses_allProcessNamesAreNonBlank() {
        for (ProcessModel process : scannedProcesses) {
    ...
    void scanProcesses_topRamRankIsOne() {
        ProcessModel highestRamProcess = scannedProcesses.stream()
    ...
    void scanProcesses_topCpuRankIsOne() {
        ProcessModel highestCpuProcess = scannedProcesses.stream()
    ...
    void scanProcesses_canBeCalledMultipleTimes() {
        ProcessScannerService scanner = new ProcessScannerService();
        List<ProcessModel> firstScan = scanner.scanProcesses();
        List<ProcessModel> secondScan = scanner.scanProcesses();
